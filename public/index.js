...
function renderCityInfo({ categories: scores, summary, teleport_city_score: overallScore }) {
    ...
    <div class="scores">
      ${scores
				.map(
					({ name, color, score_out_of_10: score }) => `<div class="score-group">
  ...
  <h3>Job Listings</h3>
    ${jobsArr
      ...
      <div class="listing">
        ...
        ${numEmployees ? `<p>Number of Employees: ${numEmployees}</p>` : ""}
